...
public class AutoAim {
  ...
  private ConfigurableParameter<Double> shooterDisengagedProportion =
      new ConfigurableParameter<>(0.5, "ShooterDisengagedProportion");
  ...
  public Command autoAimCmd(BooleanSupplier shooterEngaged) {
    return Commands.parallel(
        ...
        shooter.runSpeed(
            () -> RPM.of(parameters.flywheelSpeed() * shooterDisengagedProportion.get())));
  }
}
