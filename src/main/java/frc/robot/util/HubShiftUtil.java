...
public class HubShiftUtil {
    ...
    private static double approachingActiveFudge() {
        return -1 * (ShotCalculator.dm.getMinTimeOfFlight(false) + minFuelCountDelay);
    }

    private static double endingActiveFudge() {
        return shiftEndFuelCountExtension
                + -1 * (ShotCalculator.dm.getMaxTimeOfFlight(false) + maxFuelCountDelay);
    }
