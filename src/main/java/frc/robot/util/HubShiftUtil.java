...
// // the root directory of the linked project.
...
// ShiftEnum currentShift, double elapsedTime, double remainingTime, boolean
// active) {
// }
...
// private static final double[] shiftStartTimes = { 0.0, 10.0, 35.0, 60.0,
// 85.0, 110.0 };
// private static final double[] shiftEndTimes = { 10.0, 35.0, 60.0, 85.0,
// 110.0, 140.0 };
...
// ShotCalculator.getMinTimeOfFlight();
// private static final double maxTimeOfFlight =
// ShotCalculator.getMaxTimeOfFlight();
// private static final double approachingActiveFudge = -1 * (minTimeOfFlight +
// minFuelCountDelay);
...
// private static final boolean[] activeSchedule = { true, true, false, true,
// false, true };
// private static final boolean[] inactiveSchedule = { true, false, true, false,
// true, true };
...
// 140.0
// };
// return getShiftInfo(shiftSchedule, shiftedShiftStartTimes,
// shiftedShiftEndTimes);
// }
// double[] shiftedShiftStartTimes = {
// 0.0,
