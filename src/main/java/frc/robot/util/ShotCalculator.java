...
public class ShotCalculator {
        ...
        private static ConfigurableParameter<Double> phaseDelay = new ConfigurableParameter<Double>(0.05,
                        "Phase Delay");
        private static ConfigurableParameter<Double> rotPhaseDelay = new ConfigurableParameter<Double>(0.05,
                        "Rotation Phase Delay");
        private static ConfigurableParameter<Double> maxDistance = new ConfigurableParameter<Double>(5.5,
                        "Max Distance");
        ...
        public static Transform3d robotToTurret = new Transform3d(Units.inchesToMeters(6.75),
        ...
        public ShootingParameters getParameters(Pose3d targetPose, boolean secondaryValues) {
                ...
                double targetFlywheelSpeed = dm.getShotFlywheelSpeedMap(secondaryValues)
                ...
                double acceptableAngle = Math
                                .atan2(RobotContainer.getInstance().autoTargetUtil.inAllianceZone()
                                                ? safeHubShootTolerance.get()
                ...
                latestParameters = new ShootingParameters(
                                ...
                                turretAngle,
                                Math.min(hoodPosition, HoodConstants.maxPosition), targetFlywheelSpeed);
