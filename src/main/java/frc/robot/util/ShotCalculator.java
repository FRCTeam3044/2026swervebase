...
public class ShotCalculator {
  ...
  public record ShootingParameters(
      boolean isValid, Rotation2d turretAngle, double hoodPosition, double flywheelSpeed) {}
  ...
  private static final InterpolatingTreeMap<Double, Rotation2d> shothoodPositionMap =
  ...
  public ShootingParameters getParameters() {
    ...
    ChassisSpeeds robotRelativeVelocity =
        Robot.robotContainer.drive.getRobotRelativeChassisSpeeds();
    estimatedPose =
        estimatedPose.exp(
            new Twist2d(
    ...
    Translation2d target =
        Robot.robotContainer.autoTargetUtil.getHub().getTranslation().toTranslation2d();
    ...
    if (Double.isNaN(lasthoodPosition)) lasthoodPosition = hoodPosition;
