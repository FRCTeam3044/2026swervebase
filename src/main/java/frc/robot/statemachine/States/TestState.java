...
public class TestState extends State {
  public TestState(StateMachineBase stateMachine, CommandXboxController TestController, Drive drive, Hood hood,
    ...
    t(testController.a()).whileTrue(hood.moveHood());
    t(testController.b()).whileTrue(intake.intakeTop());
    t(testController.x()).whileTrue(intake.intakeBottom());
    t(testController.y()).whileTrue(intake.runRollers());
