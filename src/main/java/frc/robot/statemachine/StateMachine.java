...
public class StateMachine extends StateMachineBase {
        ...
        public StateMachine(
                ...
                // State auto = new AutoState(this, autoChooser, turret, hood, intake,
                // spindexer);
                ...
                // AutoClimb leftClimb = new AutoClimb(this, autoTargetUtil,
                // AutoTargetUtil.getLeftTower(), autoAim, drive,
                // climber);
                // AutoClimb rightClimb = new AutoClimb(this, autoTargetUtil,
                // AutoTargetUtil.getRightTower(), autoAim,
                // drive,
                // climber);
                ...
                // autoAim);
                // ShootToHub shootHub = new ShootToHub(this, autoTargetUtil, drive, intake,
                // spindexer, kicker, turret,
                // hood, shooter,
                // autoAim);
                // SecondShoot secondScore = new SecondShoot(this, autoTargetUtil, drive,
                ...
                // LeftFirstTransition leftFirstTransition = new LeftFirstTransition(this,
                // drive);
                // RightFirstTransition rightFirstTransition = new RightFirstTransition(this,
                // drive);
                // IntakeDepot intakeDepot = new IntakeDepot(this, autoTargetUtil, autoAim,
                // drive, intake, kicker,
                // shooter);
                // IntakeOutpost intakeOutpost = new IntakeOutpost(this, autoTargetUtil,
                // autoAim, drive, intake, kicker,
                // shooter);
                ...
                // Collections.addAll(leftDoubleSweep, AutoSteps.ShootToHub,
                // AutoSteps.LeftIntake,
                ...
                // Collections.addAll(rightDoubleSweep, AutoSteps.ShootToHub,
                // AutoSteps.RightIntake,
                ...
                // Collections.addAll(shootDepot, AutoSteps.ShootToHub, AutoSteps.IntakeDepot,
                // AutoSteps.EmptyState);

                // Collections.addAll(shootOutpost, AutoSteps.ShootToHub,
                // AutoSteps.IntakeOutpost, AutoSteps.EmptyState);

                // Collections.addAll(leftInOutAuto, AutoSteps.ShootToHub,
                // AutoSteps.LeftFirstTransition,
                // AutoSteps.LeftInOut,
                // AutoSteps.LeftTransition,
                ...
                // Collections.addAll(rightInOutAuto, AutoSteps.ShootToHub,
                // AutoSteps.RightFirstTransition,
                ...
                // auto.withChild(shootHub, () -> currentStep == AutoSteps.ShootToHub, 0, "Auto
                // to hub shot")
                // .withChild(secondScore, () -> currentStep == AutoSteps.SecondScore, 0,
                // "Auto to second score")
                // .withChild(leftClimb, () -> currentStep == AutoSteps.LeftClimb, 0, "Auto to
                // left climb")
                // .withChild(rightClimb, () -> currentStep == AutoSteps.RightClimb, 0,
                // "Auto to right climb")
                // .withChild(intakeAllianceZone, () -> currentStep ==
                // AutoSteps.IntakeAllianceZone, 0,
                ...
                // .withChild(shootToAlliedSide, () -> currentStep ==
                // AutoSteps.ShootToAlliedSide, 0,
                ...
                // .withChild(rightTransition, () -> currentStep == AutoSteps.RightTransition,
                // 0,
                // "Auto to rightTransition")
                // .withChild(leftFirstTransition, () -> currentStep ==
                // AutoSteps.LeftFirstTransition, 0,
                // "Auto to left first transition")
                // .withChild(rightFirstTransition, () -> currentStep ==
                // AutoSteps.RightFirstTransition, 0,
                ...
                // leftClimb.withTransition(auto, currentStateComplete, 0, "Left climb to
                // auto");
                ...
                // secondScore.withTransition(auto, currentStateComplete, "Second score to
                // auto");
                // shootToAlliedSide.withTransition(auto, currentStateComplete, 0, "Neutral shot
                // to auto");
                // intakeAllianceZone.withTransition(auto, currentStateComplete, 0, "Allied
                // intake to auto");
                // leftIntake.withTransition(auto, currentStateComplete, 0, "Left to right to
                // auto");
                // rightIntake.withTransition(auto, currentStateComplete, "Right to left to
                // auto");
                // intakeDepot.withTransition(auto, currentStateComplete, "Depot intake to
                // auto");
                // intakeOutpost.withTransition(auto, currentStateComplete, "Outpost intake to
                // auto");
                // leftTransition.withTransition(auto, currentStateComplete, 0, "Left transition
                // to auto");
                // rightTransition.withTransition(auto, currentStateComplete, 0, "Right
                // transition to auto");
                // leftFirstTransition.withTransition(auto, currentStateComplete, 0, "Left first
                // transition to auto");
                // rightFirstTransition.withTransition(auto, currentStateComplete, 0, "Right
                // first transition to auto");
                // leftInOut.withTransition(auto, currentStateComplete, 0, "Left in out to
                // auto");
                // rightInOut.withTransition(auto, currentStateComplete, 0, "Right in out to
                // auto");
                // farLeftInOut.withTransition(auto, currentStateComplete, 0, "Far left in out
                // to auto");
                // farRightInOut.withTransition(auto, currentStateComplete, 0, "Far right in out
                // to auto");
